...
var AeonPreferencesSchema = exports_external.object({
  theme: exports_external
    ...
    .default({}),
  security: exports_external
    .object({
      disabledApps: exports_external
        .array(exports_external.string())
        .default([]),
      disabledMcps: exports_external
        .array(exports_external.string())
        .default([]),
      blockedSites: exports_external
        .array(exports_external.string())
        .default([]),
    })
    .default({}),
  stargate: StargateConfigSchema.default({}),
  locale: exports_external
    .object({
      timezone: exports_external.string().optional(),
      language: exports_external.string().optional(),
    })
    .default({}),
  agent: exports_external
    .object({
